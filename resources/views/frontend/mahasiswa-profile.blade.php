...
<div class="container profile-edit-container">
    <div class="profile-header">
        ...
        <p>Lengkapi semua data profil Anda</p>
    </div>
    ...
    <div class="profile-card">
        <form method="POST" action="{{ route('frontend.mahasiswa-profile.update') }}">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('tempat_lahir') ? 'is-invalid' : '' }}" type="text" name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir', $mahasiswa->tempat_lahir) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control date {{ $errors->has('tanggal_lahir') ? 'is-invalid' : '' }}" type="text" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', $mahasiswa->tanggal_lahir) }}" required>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender" required>
                                ...
                                @foreach(App\Models\Mahasiswa::GENDER_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('gender', $mahasiswa->gender) === $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}" name="alamat" id="alamat" rows="3" required>{{ old('alamat', $mahasiswa->alamat) }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('tahun_masuk') ? 'is-invalid' : '' }}" type="number" name="tahun_masuk" id="tahun_masuk" value="{{ old('tahun_masuk', $mahasiswa->tahun_masuk) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('kelas') ? 'is-invalid' : '' }}" name="kelas" id="kelas" required>
                                ...
                                @foreach(App\Models\Mahasiswa::KELAS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('kelas', $mahasiswa->kelas) === $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('kelas'))
