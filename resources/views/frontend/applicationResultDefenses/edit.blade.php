        ...
        <div class="col-lg-10">
            <div class="form-card">
                <div class="form-header">
                    <h2>Edit Hasil Sidang Skripsi</h2>
                    <p>Perbarui dokumen hasil sidang skripsi Anda</p>
                </div>

                <form method="POST" action="{{ route("frontend.application-result-defenses.update", [$applicationResultDefense->id]) }}" enctype="multipart/form-data" id="defenseResultForm">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-body">
                        ...
                        <div class="info-box info">
                            ...
                            <div class="info-box-text">
                                <ul class="mb-0">
                                    ...
                                    <li>Dokumen yang sudah diupload akan ditampilkan di dropzone</li>
                                    <li>Upload ulang untuk mengganti dokumen yang sudah ada</li>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('note') is-invalid @enderror" name="note" id="note" rows="4" placeholder="Catatan dan saran perbaikan dari dosen penguji..." maxlength="5000">{{ old('note', $applicationResultDefense->note) }}</textarea>
                            @error('note')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date @error('revision_deadline') is-invalid @enderror" type="text" name="revision_deadline" id="revision_deadline" value="{{ old('revision_deadline', $applicationResultDefense->revision_deadline) }}" placeholder="Pilih tanggal">
...
<script>
// Validation flags
let hasReportDocument = {{ $applicationResultDefense->report_document && count($applicationResultDefense->report_document) > 0 ? 'true' : 'false' }};
let hasAttendanceDocument = {{ $applicationResultDefense->attendance_document ? 'true' : 'false' }};
