    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.prodis.update", [$prodi->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="code">{{ trans('cruds.prodi.fields.code') }}</label>
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $prodi->code) }}">
                            @if($errors->has('code'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $prodi->name) }}">
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{ old('slug', $prodi->slug) }}">
                            @if($errors->has('slug'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('slug') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $prodi->description) }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="status" id="status" value="1" {{ $prodi->status || old('status', 0) === 1 ? 'checked' : '' }}>
