                        ...
                        <div class="col-md-6">
                            ...
                            <h5 class="font-weight-semibold">
                                @if($applicationSchedule->schedule_type === 'mbkm_seminar')
                                    <i class="fas fa-chalkboard-teacher text-primary"></i> Review Kelayakan Proposal (MBKM)
                                @elseif($applicationSchedule->schedule_type === 'skripsi_seminar')
                                    <i class="fas fa-presentation text-info"></i> Review Kelayakan Proposal (Reguler)
