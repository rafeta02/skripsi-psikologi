                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.mahasiswas.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tahun_masuk" id="tahun_masuk" value="{{ old('tahun_masuk', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="kelas" id="kelas">
                                ...
                                @foreach(App\Models\Mahasiswa::KELAS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('kelas', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('kelas'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir') }}">
