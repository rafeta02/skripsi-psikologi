                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.application-result-seminars.update", [$applicationResultSeminar->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="note" id="note">{{ old('note', $applicationResultSeminar->note) }}</textarea>
                            @if($errors->has('note'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('note') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="revision_deadline" id="revision_deadline" value="{{ old('revision_deadline', $applicationResultSeminar->revision_deadline) }}">
