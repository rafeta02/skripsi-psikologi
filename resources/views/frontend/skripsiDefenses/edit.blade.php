                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.skripsi-defenses.update", [$skripsiDefense->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $skripsiDefense->title) }}">
                            @if($errors->has('title'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('title') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="abstract" id="abstract" value="{{ old('abstract', $skripsiDefense->abstract) }}">
