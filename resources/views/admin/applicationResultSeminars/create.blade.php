    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.application-result-seminars.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meeting_recording_link') ? 'is-invalid' : '' }}" type="url" name="meeting_recording_link" id="meeting_recording_link" value="{{ old('meeting_recording_link') }}" placeholder="https://zoom.us/rec/share/...">
