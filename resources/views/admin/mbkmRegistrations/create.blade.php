...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.mbkm-registrations.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_mbkm') ? 'is-invalid' : '' }}" type="text" name="title_mbkm" id="title_mbkm" value="{{ old('title_mbkm', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lokasi_kkn') ? 'is-invalid' : '' }}" type="text" name="lokasi_kkn" id="lokasi_kkn" maxlength="255" value="{{ old('lokasi_kkn', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_sks_taken') ? 'is-invalid' : '' }}" type="number" name="total_sks_taken" id="total_sks_taken" value="{{ old('total_sks_taken', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_mk_kuantitatif') ? 'is-invalid' : '' }}" type="text" name="nilai_mk_kuantitatif" id="nilai_mk_kuantitatif" value="{{ old('nilai_mk_kuantitatif', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_mk_kualitatif') ? 'is-invalid' : '' }}" type="text" name="nilai_mk_kualitatif" id="nilai_mk_kualitatif" value="{{ old('nilai_mk_kualitatif', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_mk_statistika_dasar') ? 'is-invalid' : '' }}" type="text" name="nilai_mk_statistika_dasar" id="nilai_mk_statistika_dasar" value="{{ old('nilai_mk_statistika_dasar', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_mk_statistika_lanjutan') ? 'is-invalid' : '' }}" type="text" name="nilai_mk_statistika_lanjutan" id="nilai_mk_statistika_lanjutan" value="{{ old('nilai_mk_statistika_lanjutan', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_mk_konstruksi_tes') ? 'is-invalid' : '' }}" type="text" name="nilai_mk_konstruksi_tes" id="nilai_mk_konstruksi_tes" value="{{ old('nilai_mk_konstruksi_tes', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_mk_tps') ? 'is-invalid' : '' }}" type="text" name="nilai_mk_tps" id="nilai_mk_tps" value="{{ old('nilai_mk_tps', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sks_mkp_taken') ? 'is-invalid' : '' }}" type="number" name="sks_mkp_taken" id="sks_mkp_taken" value="{{ old('sks_mkp_taken', '') }}" step="1">
