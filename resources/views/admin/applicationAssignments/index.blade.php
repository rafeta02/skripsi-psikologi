...
@can('application_assignment_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.application-assignments.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ApplicationAssignment">
            <thead>
                <tr>
                    <th width="10">
...
@can('application_assignment_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.application-assignments.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.application-assignments.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'application_status', name: 'application.status' },
{ data: 'lecturer_nidn', name: 'lecturer.nidn' },
{ data: 'role', name: 'role' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ApplicationAssignment').DataTable(dtOverrideGlobals);
