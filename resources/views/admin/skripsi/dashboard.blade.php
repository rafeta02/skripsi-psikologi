        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><i class="fas fa-tachometer-alt mr-2"></i> Dashboard Skripsi</span>
                    <a href="{{ route('admin.skripsi.dashboard.export-mbkm-rekap') }}" class="btn btn-success btn-sm">
                        <i class="fas fa-file-excel mr-1"></i> Export Rekap MBKM Riset
                    </a>
                </div>
                <div class="card-body">
