...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.application-schedules.update", [$applicationSchedule->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('waktu') ? 'is-invalid' : '' }}" type="text" name="waktu" id="waktu" value="{{ old('waktu', $applicationSchedule->waktu) }}">
                @if($errors->has('waktu'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('custom_place') ? 'is-invalid' : '' }}" type="text" name="custom_place" id="custom_place" value="{{ old('custom_place', $applicationSchedule->custom_place) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('online_meeting') ? 'is-invalid' : '' }}" type="text" name="online_meeting" id="online_meeting" value="{{ old('online_meeting', $applicationSchedule->online_meeting) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $applicationSchedule->note) }}</textarea>
                @if($errors->has('note'))
