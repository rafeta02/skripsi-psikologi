        ...
        <form method="POST" action="{{ route("admin.dosens.update", [$dosen->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="mbkm_availability" id="mbkm_availability" value="1" {{ $dosen->mbkm_availability || old('mbkm_availability', 0) == 1 ? 'checked' : '' }}>
