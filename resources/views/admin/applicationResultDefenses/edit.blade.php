    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.application-result-defenses.update", [$applicationResultDefense->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('final_title') ? 'is-invalid' : '' }}" type="text" name="final_title" id="final_title" value="{{ old('final_title', $applicationResultDefense->final_title) }}" maxlength="500" required>
