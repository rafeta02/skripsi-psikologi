                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title mb-0">
                                ...
                                @endif
                                <a href="{{ route('mahasiswa.pengumuman.show', $announcement) }}" class="text-dark">
                                    {{ $announcement->title }}
                                </a>
                            </h5>
                        ...
                        <a href="{{ route('mahasiswa.pengumuman.show', $announcement) }}" class="btn btn-sm btn-outline-primary">
                            Baca selengkapnya
                        </a>
                    </div>
                </div>
