...
class StoreSkripsiDefenseRequest extends FormRequest
{
    ...
    protected function directUploadRules(): array
    {
        return [
            ...
            'sdgs.*' => ['integer', Rule::in(array_keys(SkripsiDefense::sdgOptions()))],
    ...
    public function messages()
    {
        return [
            ...
            'data_collection_letter.required' => 'Surat Keterangan Telah Melaksanakan Penelitian / Data Responden / Informed consent harus diupload minimal 1 file',
            ...
            'transcript.required' => 'Transkrip nilai sementara harus diupload',
            'research_poster.required' => 'Poster penelitian harus diupload minimal 1 file',
            'siakad_supervisor_screenshot.required' => 'Screenshot pembimbing skripsi dari SIAKAD harus diupload',
